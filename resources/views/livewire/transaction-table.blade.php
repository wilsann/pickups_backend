{{-- <x-app-layout> --}}
    <div class="mx-auto">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-3">
                <input type="text" class="form-control block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" wire:model="search" placeholder="Cari Berdasarkan Id" name="" id="">
            </div>
